...
export const get = () => {
  ...
  if (customSettings) settings = Utils.mergeDeep(settings, customSettings);

  settings = Utils.mergeDeep(settings, storedSettings);

  return settings;
};

export const set = (newSettings) => {
  ...
  window.localStorage.setItem(
    ...
    // save the settings in local system.
